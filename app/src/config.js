...
const config = {
  ...
  mailExistsDebounceSeconds: clamp(Number(process.env.MAIL_EXISTS_DEBOUNCE_SECONDS || 1), 1, 10),
  mailFastScanMaxCandidates: clamp(Number(process.env.MAIL_FAST_SCAN_MAX_CANDIDATES || 3), 1, 10),
  mailScanMaxCandidates: clamp(Number(process.env.MAIL_SCAN_MAX_CANDIDATES || 10), 1, 50),
